...
class EmployeeAddress extends Model
{
    ...
    public function localCountryId(){
        return $this->belongsTo('App\Models\Country','local_country_id','id');
    }
    public function localCityId(){
        return $this->belongsTo('App\Models\City','local_city_id','id');
    }
    public function homeCountryId(){
        return $this->belongsTo('App\Models\Country','home_country_id','id');
    }
    public function homeCityId(){
        return $this->belongsTo('App\Models\City','home_city_id','id');
    }
